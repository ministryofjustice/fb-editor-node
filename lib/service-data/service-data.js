...
/*
 *  We delete a property by passing `undefined` as the third argument to `setInstanceProperty`
 *
 *  Here, there is no third argument -- it is implicit that the third argument to `setInstanceProperty`
 *  is undefined -- ensuring that the property is deleted, rather than calling `setInstanceProperty`
 *  and (accidently) supplying a valid value
 */
serviceData.deleteInstanceProperty = (_id, propertyKey) => serviceData.setInstanceProperty(_id, propertyKey)
