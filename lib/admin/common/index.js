...
const isObject = (value) => (value || false) instanceof Object && !isArray(value)
...
const getPropertyKey = (parentProperty = '', property = '') => parentProperty ? [parentProperty, property].join('.') : property
