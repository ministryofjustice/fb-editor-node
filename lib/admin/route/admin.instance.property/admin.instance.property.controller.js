...
async function postValidation (pageInstance, pageData, postRedirect) {
  ...
  const value = instancePropertyKey === 'steps'
    ? addUploadSteps(currentValue, transformValueToDataType(instancePropertyValue, schemaProperties, property))
    : transformValueToDataType(instancePropertyValue, schemaProperties, property)
