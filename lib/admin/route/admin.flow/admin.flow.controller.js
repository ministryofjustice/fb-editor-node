...
const getComponentController = require('@ministryofjustice/fb-runner-node/lib/controller/component/get-component-controller')
...
async function getFlowStep (_id, pageData, options = {}) {
...

  {
    const {
      setContents
    } = getComponentController(flowStep)
